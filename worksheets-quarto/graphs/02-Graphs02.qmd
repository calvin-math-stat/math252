...
```{r graphs02-example01, echo = FALSE, fig.align = "center", out.width = "80%"}
knitr::include_graphics("images/GraphFigs-9-6-9-7.png") 
```

```{r graphs02-example02, echo = FALSE, fig.align = "center", out.width = "80%"}
knitr::include_graphics("images/GraphFigs-9-8-9-9.png")
```

```{r graphs02-example03, echo = FALSE, fig.align = "center", out.width = "35%"}
...
## Some Terminology
  ...
  * A **path** in a graph is a sequence of edges, each one incident to the next.
    * If multiple edges are not allowed, this can also be described as a 
    sequence of vertices, each one adjacent to the next.
...
These questions will help make sure you understand the terminology above.
 ...
 4. In Figure 9, assume that $a \to b$ means team $a$ defeated team $b$.   
