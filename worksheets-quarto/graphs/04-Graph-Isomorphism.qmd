...
More informally, **to show that two graphs are isomorphic, we must show how to match up
vertices in one graph with vertices in the other so that edges are preserved.**
...
![](images/GraphEx-9-3-39.png){width="40%" fig-align="center"}
...
::: {layout-ncol=2}
![a](images/GraphFig-9-3-9.png){fig-height="10%"}

![b](images/GraphFig-9-3-10.png)
...
![a](images/GraphFig-9-3-12.png)

    
![b](images/GraphEx-9-3-63.png)

    
![c](images/GraphEx-9-3-43.png)

![d](images/GraphEx-9-3-37.png)
:::
