...
:::{#exr-nfa-specification}
To specify an NFA, what five things must you provide?

In the next four exercises, be sure to specify all five things. 
Feel free to draw pictures, but also describe these five things in words.
:::
...
:::{#exr-inefficient-nfa}
The method outlined above to convert a regular expression into an equivalent
NFA is automatic (you could fairly easily write a
...
<!-- Note: The DFA produced here is missing the {} state. -->
