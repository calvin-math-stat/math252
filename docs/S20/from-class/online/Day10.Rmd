...
<div class = "foldable" label = "Exercise 3.5.14">
...
<div class = "foldable" label = "Exercise 4.2.21">

We did this problem together in class.  There should be a video in our teams 
channel for you to watch if you want to see an replay.

<div class = "foldable" label = "Here's our DFA">
...
f. $\mybold{(0 \cup 01)^*}$ is the langauge consisting of all strings that do not start with a 1 and do not have two adjacent $1$'s.  (The empty string is included in this.)
</div>
