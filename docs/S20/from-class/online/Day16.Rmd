...
class, Read the first part of section 4.5 of our Zybook, up to an including
...
<div class = "foldable" label = "Ideas behing the Pumping Lemma"> 
...
Suppose $L$ is a regular language.  Then there must be a DFA $M$ that recoginizes
...
* $l(u) < N$,
* $l(v) > 0$,
* $x \in L$ if and only if $uv^kw \in L$ for every naturual number $k$.
