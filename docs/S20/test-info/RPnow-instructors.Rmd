...
* Website: <http://calvin.remoteproctor.com/adminsite>
...
connection between the two systems and keeps students form taking the Moodle quiz outside
...
* Indicate whether the exam is **proctored** or not. (Set up a non-proctored test as 
...
* Student will need a Mac or PC with a new enough operating sysgtem.  Linux and iOS are not supported.
* Students must have a working webcam to use the system.
* Even if you walk students through the process and provide detailed written instructions,
you will get questions from students.  Most common questions I had:

    * Where are the instructions?
    * What's the password? (They should not know it, there is a big green button for
    them to push the populates the password field.)
    * 
