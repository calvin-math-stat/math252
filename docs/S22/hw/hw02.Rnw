...
\begin{longtable}{|c|c|c|p{4.3in}|}
  ...
  \hline\hline
  \endhead
	 Wed 2/16 & \WW{06} & Rosen 7 & Probability
	 \\
	   \hline
	 Fri 2/18 & \WW{07} & Rosen 7 & Probability
	 \\
	   \hline
	 Mon 2/21 & \WW{08} & Rosen 7 & Probability
	 ...
	 \\
	   \hline
	 Fri 2/25 & \WW{09} & Rosen 7 & Probability
	 \\
	 \hline
	 Wed 3/9 & PS 10 & Rosen 7.4 &
	 \helper{1}
	 \mand[rolling 6s]{3}
	 \mand[biased coin]{4}
	 \extra[loaded die]{5}
	 ...
	 \\
	 \hline
	 Fri 3/11 & \WW{10} & Rosen 6--7 & Probability
	 \\
...
\end{document}
	   \hline
	 Wed 3/9 & \WW{10} & Rosen 7 & probability review
	 \\
	 \hline

	 Mon 3/29 & PS 11 & Rosen 13.1 &
   \mand[sentences]{1ad}
	 \extra{2}
	 \helper{3}
	 \mand{4}
