...
the plane without any edges crossing.
 ...
 8. Show that $K_4$ and $Q_3$ are both planar graphs.
...
the paper and without repeating anything.
 ...
 9. Which kind of path is this puzzle asking for?

 10. Which of these can you trace in this manner?
...
```
 ...
 11. Create a graph that represents the Königsberg Bridge Puzzle (so it can be traced 
...
\vfill
 ...
 12. Can you trace the Königsberg Bridge graph?
...
Fill in the table below for the graphs above.
...
13. **The Blue Prince's eighth bridge.**
...
14. **The Red Prince's ninth bridge.**
