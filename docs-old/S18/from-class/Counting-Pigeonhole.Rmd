...
\vfill
 ...
 1. Suppose (in some alternative reality) that Professor Pruim brought 150 cookies to
    ...
    b. This means the at least one student had at least _______ cookies.
    c. This means the at least one student had at most _______ cookies.
...
\vfill
 ...
 6. For his birthday, Joe received a gift of 8 of red socks
...
\vfill
 ...
 connections at a time.
    ...
    workstations simultaneously.  (No matter what we do, we won't able to connect
    11 workstations to servers since there are only 10 servers.)
    
    c. Show that 59 connections is not enough.  That is, no matter how you do the 
    connecting, there will always be a combination of 10 workstations that cannot
    simultaneously connect to servers.  (Hint: on average, how many connections are 
    there per server?)
