...
We'll return to this problem in just a moment.  But first, a different sort of puzzle.
 ...
 12. Create a graph that represents the Königsberg Bridge Puzzle (so it can be traced 
...
14. **The Blue Prince's eighth bridge.**
...
15. **The Red Prince's ninth bridge.**
