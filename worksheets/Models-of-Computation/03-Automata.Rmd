...
where $S$ is the set of states, $I$ is the input alphabet, and $P(S)$ is the powerset of $S$.  (The powerset of $S$ is the set of all subsets of $S$.
So the transition function for an NFA returns a *set* of states.)
...
17. Given an NFA $N$, is it always possible to create a DFA $M$ that recognizes the same language?  If so,
