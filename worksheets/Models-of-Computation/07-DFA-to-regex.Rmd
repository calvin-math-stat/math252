...
to "rip out". Let's call that state $R$.
    ...
    replacejevery $A \stackrel{r_{\mathrm{in}}}{\to} R \stackrel{r_{\mathrm{out}}} \to B$ with 
...
1. Show that if $A$ is a regular language, then $\overline{A}$ is also a regular
language.

1. Show that if $A$ and $B$ are regular languages, then $A \intersect B$ is also
a regular language.

1. Convert the machines on this sheet to equivalent regular grammars.
