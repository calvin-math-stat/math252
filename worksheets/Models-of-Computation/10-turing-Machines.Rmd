...
the **blank symbol**. 
  ...
  * Traditionally, the blank symbol is denoted $\not\! b$ or
  b or B or \textvisiblespace\ or with an underscore. Zylabs is quirky and uses *.
* **states**: A finite set.
...
* **program**: A list of **instructions**. Each instruction has 5 parts:
    ...
    * `<direction>`: left, right, or stay 
      *  Some flavors of Turing machine, including the flavor in our Zybook
      do not allow stay.
...
3. Convert the Turing machine in the table below (Zybook table 4.5.2)

$\delta$ |  a	        |  b	          | *
-------- | :--------: | :-----------: | :-----------:
q0	     | (q0, a, R)	| (q1, b, R)	  | (qrej, *, L)
q1	     | (q1, a, R)	| (qacc, b, L)	| (qrej, *, L)
...
## Computing funcitons with a Turing machine
