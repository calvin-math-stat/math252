...
(In some variations there are two kinds of final states: accepting and regecting.)
...
but no longer usable since it was written in java by Calvin student Eliot Eschlemaman
...
* Which of variaous variations on the the 1-tape Turing machine theme they support (and how you
...
on input $x$ it halts in a final state. The language of a Turing machine is 
