...
3. In Rosen 7, the definition of regular expression is missing boldface
...
4. What is the difference between $\bm{1}$ and $1$?
between $\bm{\lambda}$ and $\lambda$?
between $\bm{\emptyset}$ and $\emptyset$?
...
6. Can each of the languages above be recongized by an NFA? a DFA?

7. What would we need to do to show that every regualar language can be recognized by an NFA?
