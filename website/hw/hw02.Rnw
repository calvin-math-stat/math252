...
\begin{longtable}{|c|c|c|p{4.3in}|}
  ...
  \hline\hline
  \endhead
	 Wed 2/15 & \WW{06} & Rosen 7 & Probability
	 \\
	   \hline
	 Fri 2/17 & \WW{07} & Rosen 7 & Probability
	 \\
	   \hline
	 Mon 2/20 & \WW{08} & Rosen 7 & Probability
	 ...
	 \\
	   \hline
	 Fri 2/24 & \WW{09} & Rosen 7 & Probability
	 \\
	 \hline
\end{longtable}
\end{center}
